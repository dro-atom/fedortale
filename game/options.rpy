...
define config.name = _("Fedortale")
...
define gui.about = _p("""Это игра, созданная под впечатлением от прохождения игры Undertale, автором которой является Toby Fox, и ознакомления с фандом-вселенной {i}Fedor Comix{/i}. Fedor Comix - видеоблогер на YouTube. Он создал свою вселенную Fedortale, но отказался её развивать и продвигать. Так что автор этой новеллы, Kira Cactus, решилась взять эту ношу на себя. Поддержать автора вы можете по ссылке  
{a=vk.com/fedortale}на паблик в ВК{/a} Можете подписаться и на самого {a=vk.com/fedorcomix}Фёдора{/a}""")
...
define build.directory_name = "Fedortale" 
define build.name = "Fedortale"
...
define config.main_menu_music = "mus_musicbox.ogg"
...
define config.save_directory = "Fedortale-1525373375"
