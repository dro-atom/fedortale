label besik_end:
    ...
    show besik_usual: 
        ...
        yalign 0.4
    with dissolve
    voice "audio/voice/besik1.mp3"
    B "А? Кто здесь?"
    voice "audio/voice/besik2.mp3"
    hide besik_usual 
    show besik_good: 
        xalign 0.5
        yalign 0.4
    ...
    show besik_fuck:
        ...
        yalign 0.4
    with dissolve
    voice "audio/voice/besik13.mp3"
    Bs "Не торопись."
    voice "audio/voice/besik14.mp3"
    Bs "Твоя душа..."
    voice "audio/voice/besik15.mp3"
    ...
    show besik_fuck2:
        ...
        yalign 0.4
    with dissolve
    voice "audio/voice/besik16.mp3"
    Bs "Ты просто хочешь видеть, как я мучаюсь!"
    voice "audio/voice/besik17.mp3"
    ...
    show besik_oret:
        ...
        yalign 0.4
    with vpunch
    voice "audio/voice/besik19.mp3"
    Bs "Ни слова больше! Вы все одинаковые! Вы, люди, можете только всё портить!"
    voice "audio/voice/besik20.mp3"
    Bs "Глупый человек!"
    voice "audio/voice/besik21.mp3"
    Bs "Я точно узнал твою душу!"
    voice "audio/voice/besik22.mp3"
    Bs "Finito la comedia!"
    voice "audio/voice/besik23.mp3"
    Bs "Сейчас свершится моя месть!"
    voice "audio/voice/besik24.mp3"
    Bs "Наглый, подлый, бездушный воришка!"
    voice "audio/voice/besik25.mp3"
    Bs "КАК! ЖЕ! ТЫ! МЕНЯ!"
    hide besik_oret
    show besik_besitsa:
        xalign 0.5
